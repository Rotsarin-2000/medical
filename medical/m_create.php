...
if ($id > 0) {
    ...
    if ($result_create->num_rows > 0) {
        ...
        $sql_date = "SELECT * FROM m_creates WHERE d_id = ? AND status = 0 ORDER BY id DESC";
                        ...
                        <div class="card-body">
                            <div class="row p-2">
                                <div id="employee-form" class="employee" style="display: block;">
                                    <form class="row g-3" action="/tsm_medical/inserdata/m_create.php" method="POST" id="myForm">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <select id="owner" class="form-control" name="owner">
                                                ...
                                                <option value="" selected>พนักงาน</option>
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                ...
                                <a href="pdf.php?id=<?php echo $row['id']; ?>" class="btn btn me-1 pdf">
                        ...
                        <div class="card-body">
                            <div class="table table-responsive-md">
                                <table id="example" class="table table-striped">
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <!-- <a type="button" class="btn btn" style="background-color: #7CFC00; color: #000;" onclick="toggleForms(<?php echo $row['id']; ?>)">
                                                            <i class='bx bx-edit-alt'></i>
                                                        </a> -->

                                                        <!-- ปุ่มที่คลิกเพื่อเปิด modal -->
                                                ...
                                                <!-- <div id="edit-form-<?php echo $row['id']; ?>" class="edit-form" style="display: none;">
                                                    <div class="row p-3">
                                                        <form class="row g-3" id="form_<?php echo $row['id']; ?>" action="../tsm_medical/inserupdate/up_edit_medical_create.php" method="POST">
                                                            <input type="hidden" class="form-control" name="d_id" value="<?php echo $row['d_id']; ?>">
                                                            <input type="hidden" name="status" value="<?php echo $row['status']; ?>">
                                                            <input type="hidden" name="date" value="<?php echo $medical_data['date']; ?>">
                                                            <input type="hidden" name="year" value="<?php echo $medical_data['year']; ?>">
                                                            ...
                                                            <div class="col-md-2">
                                                                <label for="age_year" class="form-label">Age Year</label>
                                                                <input type="text" id="age_year" class="form-control" name="age_year" value="<?php echo $medical_data['age_year']; ?>" required readonly>
                                                            </div>
                                                            ...
                                                            <div class="col-md-8">
                                                                <label for="remark_memo" class="form-label">Remark Memo</label>
                                                                <input type="text" id="remark_memo" class="form-control" name="remark_memo" value="<?php echo $medical_data['remark_memo']; ?>" required>
                                                            </div>
                                                            ...
                                                            <div class="col-12">
                                                                <div class="d-flex justify-content-center">
                                                                    <button type="button" class="btn btn me-1" style="background-color: #000; color: #fff; border-radius: 25px; padding: 9px 20px; margin: 10px;" onclick="toggleEditForm(<?php echo $row['id']; ?>)">
                                                                        <i class='bx bx-x-circle'></i> Close
                                                                    </button>
                                                                    <button type="submit" class="btn btn me-1 add"><i class='bx bx-check-circle'></i> Confirm</button>
                                                                </div>
                                    ...
                                    <tfoot>
                                        <tr>
                                            <td colspan="7" style="font-weight: bold; font-size: 16px;">รวมเป็นเงินทั้งสิ้น</td>
                                            <td></td>
        ...
        document.getElementById('downloadExcel').addEventListener('click', function() {
            ...
            for (var i = 0; i < table.rows.length; i++) {
                ...
                for (var j = 0; j < row.cells.length; j++) {
                    ...
                    if (j === 7 || j === 8 || j === 5 || j === row.cells.length - 1) {
                        continue;
                    }
